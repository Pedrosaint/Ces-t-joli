              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-brand-cream border border-brand-grey/20 focus:outline-none focus:border-red-500 focus:bg-white transition-colors"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={5}
                    className="w-full px-4 py-3 bg-brand-cream border border-brand-grey/20 focus:outline-none focus:border-red-500 focus:bg-white resize-none transition-colors"
                ...
                <button
                  ...
                  className="group w-full px-8 py-4 bg-brand-red text-white font-semibold hover:bg-brand-red transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
                >
                  Send Message
            ...
            {contactInfo.map((info, index) => (
              ...
              >
                <div className="flex items-start gap-4">
                  <div
                    className={`${info.color} w-12 h-12 flex items-center justify-center text-white shrink-0`}
                  >
                    {info.icon}
                  </div>
